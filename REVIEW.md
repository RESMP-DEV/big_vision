# Review guidance for RESMP-DEV/big_vision
...
- Review RESMP-DEV/big_vision as the source of truth for Official codebase used to develop Vision Transformer, SigLIP, MLP-Mixer, LiT and more.
